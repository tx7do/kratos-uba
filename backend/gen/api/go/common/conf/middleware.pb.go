...
var file_common_conf_middleware_proto_rawDesc = []byte{
	...
	0x6d, 0x61, 0x72, 0x79, 0x42, 0x27, 0x5a, 0x25, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2d, 0x62,
	0x69, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x67, 0x6f, 0x2f, 0x63, 0x6f, 0x6d,
...
func file_common_conf_middleware_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_common_conf_middleware_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_conf_middleware_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
