...
const (
	ApplicationService_ListApplication_FullMethodName       = "/user.service.v1.ApplicationService/ListApplication"
	ApplicationService_GetApplication_FullMethodName        = "/user.service.v1.ApplicationService/GetApplication"
	ApplicationService_CreateApplication_FullMethodName     = "/user.service.v1.ApplicationService/CreateApplication"
	ApplicationService_UpdateApplication_FullMethodName     = "/user.service.v1.ApplicationService/UpdateApplication"
	ApplicationService_DeleteApplication_FullMethodName     = "/user.service.v1.ApplicationService/DeleteApplication"
	ApplicationService_GetApplicationByAppId_FullMethodName = "/user.service.v1.ApplicationService/GetApplicationByAppId"
)
...
func (c *applicationServiceClient) GetApplicationByAppId(ctx context.Context, in *GetApplicationByAppIdRequest, opts ...grpc.CallOption) (*Application, error) {
	out := new(Application)
	err := c.cc.Invoke(ctx, ApplicationService_GetApplicationByAppId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ApplicationService_GetApplicationByAppId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApplicationService_GetApplicationByAppId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ApplicationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "user.service.v1.ApplicationService",
	...
	Metadata: "user/service/v1/application.proto",
}
