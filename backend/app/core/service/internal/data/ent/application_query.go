...
func (aq *ApplicationQuery) FirstIDX(ctx context.Context) uint32 {
...
func (aq *ApplicationQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (aq *ApplicationQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (aq *ApplicationQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := aq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (aq *ApplicationQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(application.Table, application.Columns, sqlgraph.NewFieldSpec(application.FieldID, field.TypeUint32))
	_spec.From = aq.sql
