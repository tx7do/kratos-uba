...
EventReport.prototype.getDefaultAttr = function () {
    ...
    return {
        ...
        "client_time": this.timeStamp2Date(this.getRegTime()),
...
EventReport.prototype.trackUserData = function () {
    ...
    userProperties["distinct_id"] = this.getUUid();
    userProperties["reg_time"] = this.timeStamp2Date(this.getRegTime());
    userProperties["update_time"] = this.timeStamp2Date(this.getTimeStamp());

    userProperties["client_time"] = this.timeStamp2Date(this.getRegTime());
